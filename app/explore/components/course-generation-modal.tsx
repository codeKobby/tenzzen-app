...
export function CourseGenerationModal({ isOpen, onClose }: CourseGenerationModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (activeTab === "link") {
                ...
                // Show video details modal instead of proceeding directly
    ...
    const handleGenerateCourse = async () => {
        try {
            // This would handle the actual course generation after video details are confirmed
    ...
    return (
        <>
            <Dialog open={isOpen && !showVideoDetails} onOpenChange={(open) => {
                if (!open) onClose()
            }}>
