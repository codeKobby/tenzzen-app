-- Add additional fields to the user_notes table for enhanced note-taking functionality
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE tablename = 'user_notes' AND policyname = 'Users can only access their own notes'
    ) THEN
        EXECUTE 'CREATE POLICY "Users can only access their own notes" ON user_notes
